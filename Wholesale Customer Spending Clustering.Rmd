...
Let's cut the tree by choosing k. I will use the average instead of the complete. Since the height is alight above 15, I will choose k to be slightly above half, which is 8. 
```{r}
