...
Hierarchical clustering treats each observation as distinct cluster. Then it merges two clusters closest together (via distance) and merges those clusers together. this process repeats until all clusters are merged as one. 
