...
Clustering is good for many reasons. In terms of business, we can use clustering for customer segmentation which can help answer 1) what people belong together and 2) how do we group them together.^(https://www.simplilearn.com/tutorials/data-science-tutorial/hierarchical-clustering-in-r) 
